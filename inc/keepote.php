...
function keepote_block($context = 'general') {
    ...
    <section class="keepote-block">
      <div class="container keepote-inner">
        <div class="keepote-visual"><img src="/assets/img/keepote-nu-assis-simple.png?v=4" width="360" height="360" alt="KeePote assis, assistant Keeplanet" loading="lazy"></div>
