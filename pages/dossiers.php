...
<section class="dossier-hero compact"><div class="container"><a class="breadcrumb" href="/dossiers/">Dossiers</a><span class="eyebrow"><?= h($cat['name']) ?></span><h1><?= h($cat['name']) ?></h1><p><?= h($cat['description']) ?></p></div></section>
...
<article class="dossier-article"><header class="dossier-article-hero"><div class="container narrow"><div class="breadcrumbs"><a href="/dossiers/">Dossiers</a><span>›</span><a href="/<?= h($article['category']) ?>/"><?= h($cat['name']) ?></a></div><span class="pill"><?= h($cat['name']) ?></span><h1><?= h($article['title']) ?></h1><p><?= h($article['excerpt']) ?></p></div></header>
